...
public class ClinicUtil
{
  public static String getHtml( List<Patient> patients )
  {
    ...
    sb.append("<tr>")
      .append("<td>").append("patientId       | ").append("</td>").append("<td>").append("currentDoctorId | ").append("</td>")
      .append("<td>").append("dentalFormulaId | ").append("</td>").append("<td>").append("name            | ").append("</td>")
      .append("<td>").append("surname         | ").append("</td>").append("<td>").append("middlename      | ").append("</td>")
      .append("<td>").append("dateOfBirth     | ").append("</td>").append("<td>").append("address").append("</td>")
      .append("</tr>");
  ...
  public static String getHtml( Map<String, String> map )
  {
    ...
    SimpleDateFormat simpleDateFormat = new SimpleDateFormat( "dd-MM-yyyy" );
    sb.append("<tr>")
    .append("<td>").append("month     | ").append("</td>").append("<td>").append("total     | ").append("</td>")
    .append("</tr>");
    for( int i=1; i<=12; i++ )
    {
      System.out.print( String.valueOf( i ) );
